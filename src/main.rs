...
//             }
//             "type" => {
//                 let cmd: &&str = args.get(0).ok_or(anyhow!("Invalid arguments"))?;
...
// struct CommandRunner<R: io::BufRead, W: io::Write> {
//     prompter: Prompter<R, W>,
//     exec_runner: ExecRunner,
// }

// impl<R: io::BufRead, W: io::Write> CommandRunner<R, W> {
//     fn new(prompter: Prompter<R, W>, exec_runner: ExecRunner) -> Self {
//         return Self {
//             prompter: prompter,
...
//     fn run_command(&self, command: Command2) {}
// }
